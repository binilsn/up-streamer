...
ActiveRecord::Schema[8.1].define(version: 2026_07_08_062802) do
  ...
  create_table "alert_rules", force: :cascade do |t|
    ...
    t.string "operator", default: "eq", null: false
    t.bigint "service_id"
    t.string "severity", default: "medium", null: false
    t.datetime "updated_at", null: false
    t.string "value", null: false
    t.index ["enabled"], name: "index_alert_rules_on_enabled"
    t.index ["field"], name: "index_alert_rules_on_field"
    t.index ["level"], name: "index_alert_rules_on_level"
    t.index ["service_id"], name: "index_alert_rules_on_service_id"
  end
  ...
  create_table "alerts", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.index ["alert_rule_id", "status"], name: "index_alerts_on_alert_rule_id_and_status"
    t.index ["alert_rule_id"], name: "index_alerts_on_alert_rule_id"
    t.index ["log_id"], name: "index_alerts_on_log_id"
    t.index ["service_id"], name: "index_alerts_on_service_id"
  ...
  add_foreign_key "alert_rules", "services"
